...
//4
let quote = "Have patience. All things are difficult before they become easy.";
let author = "Sheikh Sadi";
console.log(`${author} once said, “${quote}”`);
//5
let quote1 = "Have patience. All things are difficult before they become easy.";
let famous_person = "Sheikh Sadi";
let message1 = `${famous_person} once said, “${quote1}”`;
...
let messag4 = `My favorite number is ${favoriteNumber}.`;
console.log(messag4);
//10
// Author: [M.Jawad Asad]
// Date: 2024-07-30
// This program prints a famous quote by Sheikh Sadi.
let quote2 = "Have patience. All things are difficult before they become easy.";
let famous_person2 = "Sheikh Sadi";
let message5 = `${famous_person2} once said, “${quote2}”`;
...
while (dinnerGuests3.length > 2) {
    let removedGuest = dinnerGuests3.pop();
...
//18
let placesToVisit = ["Lahore", "Faisalabad", "Peshawar", "Islamabad", "Karachi"];
